...
urlpatterns = patterns('',
                       ...
                       url(r'^imagegetter/', include('imagegetter.urls', namespace='imagegetter')),
                       url(r'^imagesaver/', include('imagesaver.urls', namespace='imagesaver')),
                       url(r'^shelvedimages/', include('shelvedimages.urls', namespace='shelvedimages')),
